#!/usr/bin/env python3
"""
Convert onion defect segmentation dataset to COCO format for RF-DETR training.

This script converts the dataset from individual JSON files per image to COCO format.
"""
...
def convert_dataset_to_coco(source_dir, output_dir, splits={'train': 0.7, 'valid': 0.2, 'test': 0.1}, seed=42):
    """
    Convert the onion defect dataset to COCO format.
    ...
    for split_name, files in split_files.items():
        ...
        coco_output = {
            "info": {
                "description": "Onion Defect Segmentation Dataset",
                "url": "",
                "version": "1.0",
                "year": 2025,
                "contributor": "",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Convert onion defect dataset to COCO format")
    parser.add_argument(
        "--source-dir",
        type=str,
        default="datasets/onion_defect_segmentation",
